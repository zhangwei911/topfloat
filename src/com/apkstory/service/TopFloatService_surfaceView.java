...
public class TopFloatService_surfaceView extends Service {

    @Override
    public void onCreate() {
        super.onCreate();
        view = LayoutInflater.from(this).inflate(R.layout.surfaceview_float, null);
        createView();
    }
    ...
    private void createView() {
                ...
                if (event.getPointerCount() == 3) {
                    ...
                    switch (event.getAction()) {
                        ...
                        case MotionEvent.ACTION_UP:
                            //得到非第一次触屏时线段的长度
                            newLineDistance = (float) Math.sqrt
                                    (Math.pow(event.getX(1) - event.getX(0), 2) +
                                            Math.pow(event.getY(1) - event.getY(0), 2));
                            ...
                            wm.removeView(view);
                            wmParams.width = (int) (wmParams.width * rate);
                            wmParams.height = (int) (wmParams.height * rate);
                            wm.addView(view, wmParams);
                            Toast.makeText(TopFloatService_surfaceView.this, "2", Toast.LENGTH_SHORT).show();
                            break;
                    }
                    return true;
        ...
        exit_imageButton = (ImageButton) view.findViewById(R.id.exit_imageButton1);
        pause_imageButton = (ImageButton) view.findViewById(R.id.pause_imageButton1);
        play_imageButton = (ImageButton) view.findViewById(R.id.play_imageButton1);
        list_imageButton = (ImageButton) view.findViewById(R.id.list_imageButton1);
        next_imageButton = (ImageButton) view.findViewById(R.id.next_imageButton1);
        videoname_textView = (TextView) view.findViewById(R.id.videoname_textView1);
        floatfull_button = (Button) view.findViewById(R.id.floatfull_button1);
        ...
        list_imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                flags = false;
                video_play_Time = 0;
                Intent intent = new Intent(TopFloatService_surfaceView.this, ListExplorer.class);
        ...
        if (surfaceHolder != null) {
            surfaceHolder.setFixedSize(300, 200);
                ...
                if (pathindex < paths.length) {
                    try {
                       ...
                       // mediaPlayer.setDisplay(surfaceHolder);
                        ...
                        video_play_Time = 0;
                        mediaPlayer.pause();
                        Tools.showMsg(TopFloatService_surfaceView.this, getString(R.string.ExceptionExit));
                        stopSelf();
                        Intent intent = new Intent(TopFloatService_surfaceView.this, ListExplorer.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.putExtra("pathcache", value.substring(0, value.lastIndexOf("/")));
        ...
        floatfull_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TopFloatService_surfaceView.this, FullScreen.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        playtime_textView = (TextView) view.findViewById(R.id.playtime_textView1);
        wholetime_textView = (TextView) view.findViewById(R.id.wholetime_textView1);
        seek_playtime_textView = (TextView) view.findViewById(R.id.seek_palytime_textView1);

        small_toggleButton = (ToggleButton) view.findViewById(R.id.small_toggleButton1);
    ...
    private GestureDetector gd = new GestureDetector(new GestureDetector.OnGestureListener() {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            if (e1.getX() - e2.getX() > SWIPE_MIN_DISTANCE &&
                ...
                Toast.makeText(TopFloatService_surfaceView.this, "zoomin", Toast.LENGTH_SHORT).show();
                return true;
            } else if (e2.getX() - e1.getX() > SWIPE_MIN_DISTANCE &&
                    Math.abs(velocityX) > SWIPE_THRESHOLD_VELOCITY) {
                //right
                Log.i("GestureDemo", "zoomout");
                Toast.makeText(TopFloatService_surfaceView.this, "zoomout", Toast.LENGTH_SHORT).show();
                return true;
            }
            return false;
        }
